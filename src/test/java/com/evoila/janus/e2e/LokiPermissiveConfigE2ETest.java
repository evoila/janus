...
/**
 * E2E tests for Loki/LogQL using the PERMISSIVE configuration. Tests wildcard pattern matching like
 * prefix patterns (demo-*), suffix patterns (*-service), and middle patterns (*order*).
 */
@Tag("e2e")
@Tag("loki")
...
class LokiPermissiveConfigE2ETest {
  ...
  class PrefixPatternTests {
    ...
    void orderTeam_canAccessDemoPayments() {
      String query = "{k8s_namespace_name=\"demo-payments\"}";
    ...
    void orderTeam_queryForStagingOrders_returnsOnlyDemoData() {
      ...
      // Verify results only contain demo-* namespaces
  ...
  class SuffixPatternTests {
    ...
    void myTeam_queryForDemoOrders_returnsOnlyServiceData() {
      ...
      // Verify results only contain *-service namespaces
      @SuppressWarnings("unchecked")
      Map<String, Object> data = (Map<String, Object>) response.get("data");
      @SuppressWarnings("unchecked")
      List<Map<String, Object>> results = (List<Map<String, Object>>) data.get("result");
  ...
  class WildcardTeamTests {
    ...
    @Test
    @DisplayName("wildcard-team can access demo-orders (contains 'order')")
    void wildcardTeam_canAccessDemoOrders() {
      String query = "{k8s_namespace_name=\"demo-orders\"}";
    ...
    @Test
    @DisplayName("wildcard-team can access staging-orders (contains 'order')")
    void wildcardTeam_canAccessStagingOrders() {
      String query = "{k8s_namespace_name=\"staging-orders\"}";
    ...
    void wildcardTeam_queryForDemoPayments_returnsOnlyOrderData() {
      ...
      // Verify results only contain *order* namespaces
      @SuppressWarnings("unchecked")
      Map<String, Object> data = (Map<String, Object>) response.get("data");
      @SuppressWarnings("unchecked")
      List<Map<String, Object>> results = (List<Map<String, Object>>) data.get("result");
