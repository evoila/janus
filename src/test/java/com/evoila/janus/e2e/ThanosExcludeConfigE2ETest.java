...
/**
 * E2E tests for Thanos/PromQL using the EXCLUDE configuration. Tests include/exclude pattern
 * behavior where teams have explicit lists with some namespaces excluded.
 */
@Tag("e2e")
@Tag("thanos")
@Tag("exclude-config")
...
class ThanosExcludeConfigE2ETest {
  ...
  class ExcludeListTests {
    ...
    void orderTeam_cannotAccessDemoSensitive() {
      ...
      String query = "http_requests_total{namespace=\"demo-sensitive\"}";
