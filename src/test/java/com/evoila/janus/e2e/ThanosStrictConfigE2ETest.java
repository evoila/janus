...
/**
 * E2E tests for Thanos/PromQL using the STRICT configuration. Tests exact match only constraints
 * with no wildcards or patterns - each team can only see their specific namespace.
 */
@Tag("e2e")
@Tag("thanos")
@Tag("strict-config")
...
class ThanosStrictConfigE2ETest {
