...
/**
 * E2E tests for Thanos/PromQL using the REGEX configuration. Tests complex regex patterns with ~
...
class ThanosRegexConfigE2ETest {
  ...
  class AnchoredStartPatternTests {
    ...
    void orderTeam_cannotAccessNonDemoNamespace() {
      // test-demo would not match ^demo.*$ because it doesn't start with demo
